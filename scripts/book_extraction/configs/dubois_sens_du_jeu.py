...
CONFIG = BookConfig(
    ...
    lesson_chapters=[
        LessonChapter(101,   5, "Chapitre 101 : la notion d'espace",                      "generalites"),
        LessonChapter(102,   8, "Chapitre 102 : la notion d'avantage",                    "generalites"),
        LessonChapter(103,  14, "Chapitre 103 : la liberté de mouvement relative",        "generalites"),
        LessonChapter(104,  19, "Chapitre 104 : les échanges",                            "generalites"),
        LessonChapter(105,  24, "Chapitre 105 : les temps d'avance",                      "generalites"),
        LessonChapter(106,  32, "Chapitre 106 : les temps de réserve",                    "generalites"),
        LessonChapter(107,  36, "Chapitre 107 : les pions « arrière » ou « suspendus »",  "generalites"),
        LessonChapter(108,  40, "Chapitre 108 : le pion d'angle 46 (1ère partie)",        "pions_de_base"),
        LessonChapter(109,  48, "Chapitre 109 : le pion d'angle 46 (seconde partie)",     "pions_de_base"),
        LessonChapter(110,  53, "Chapitre 110 : le pion d'angle 46 (3e partie)",          "pions_de_base"),
        LessonChapter(111,  61, "Chapitre 111 : le pion de base 47 (1ère partie)",        "pions_de_base"),
        LessonChapter(112,  64, "Chapitre 112 : le pion de base 47 (2e partie)",          "pions_de_base"),
        LessonChapter(113,  68, "Chapitre 113 : le pion savant (1ère partie)",            "pions_de_base"),
        LessonChapter(114,  71, "Chapitre 114 : le pion savant (2e partie)",              "pions_de_base"),
        LessonChapter(115,  74, "Chapitre 115 : les pions de base 49 et 50",              "pions_de_base"),
        LessonChapter(116,  81, "Chapitre 116 : le pion blanc 36",                        "pions_de_bande"),
        LessonChapter(117,  86, "Chapitre 117 : le pion de bande 26",                     "pions_de_bande"),
        LessonChapter(118,  93, "Chapitre 118 : le pion de bande 16 (en création)",       "pions_de_bande"),
        LessonChapter(119,  94, "Chapitre 119 : le pion de bande 6 (en création)",        "pions_de_bande"),
        LessonChapter(120,  95, "Chapitre 120 : le pion blanc 45",                        "pions_de_bande"),
        LessonChapter(121, 102, "Chapitre 121 : le pion blanc 35",                        "pions_de_bande"),
        LessonChapter(122, 107, "Chapitre 122 : le pion blanc 25 (en création)",          "pions_de_bande"),
        LessonChapter(123, 108, "Chapitre 123 : le pion 15 - les spécificités",           "pions_de_bande"),
        LessonChapter(124, 116, "Chapitre 124 : le pion 27 (en création)",                "pions_offensifs"),
        LessonChapter(125, 117, "Chapitre 125 : le pion 28 (en création)",                "pions_offensifs"),
        LessonChapter(126, 118, "Chapitre 126 : le pion 29 (en création)",                "pions_offensifs"),
        LessonChapter(127, 119, "Chapitre 127 : le pion 22 (en création)",                "pions_offensifs"),
        LessonChapter(128, 120, "Chapitre 128 : le pion 23 (en création)",                "pions_offensifs"),
        LessonChapter(129, 121, "Chapitre 129 : le pion 24 appelé « pion taquin »",       "pions_offensifs"),
        LessonChapter(130, 127, "Chapitre 130 : la formation 45-40",                      "formations"),
        LessonChapter(131, 135, "Chapitre 131 : la flèche 33-38-42",                      "formations"),
        LessonChapter(132, 143, "Chapitre 132 : la formation 34-39-43",                   "formations"),
        LessonChapter(133, 148, "Chapitre 133 : la flèche 27-31-36 (en création)",        "formations"),
        LessonChapter(134, 149, "Chapitre 134 : la formation du marchand de bois (en création)", "formations"),
        LessonChapter(135, 150, "Chapitre 135 : la formation 34-35-40-45 (en création)",  "formations"),
    ],
