...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    exercisesDesc: "Leçons et exercices",
    historyDesc: "Consultez vos parties",
    tabImport: "Analyser",
    tabHistory: "Profil",
    importPdn: "Importer un PDN",
    importDesc: "Importez et analysez une partie PDN",
    aiThinking: "L'IA réfléchit...",
    tabPlay: "Jouer avec l'IA",
    tabExercises: "Apprendre",
    whitePerspective: "Blancs (vous) : bas du plateau",
    blackPerspective: "Noirs (vous) : bas du plateau",
    ...
    creditsThanks: "Remerciements",
    creditsSources: "Sources pédagogiques",
    creditsCorpus: "Corpus",
    turn: "Trait :",
    white: "Blancs",
    black: "Noirs",
    draw: "Nul",
    ...
    lidraughtsImporting: "Téléchargement en cours…",
    lidraughtsImported: "Parties Lidraughts chargées",
    lidraughtsImportError: "Impossible de récupérer les parties depuis Lidraughts.",
  },
  en: {
    appSubtitle: "International draughts training (100 squares)",
    home: "Home",
    playDesc: "Play against Scan AI",
    exercisesDesc: "Lessons and exercises",
    historyDesc: "Browse your games",
    tabImport: "Analyze",
    tabHistory: "Profile",
    importPdn: "Import a PDN",
    importDesc: "Import and analyze a PDN game",
    aiThinking: "AI is thinking...",
    tabPlay: "Play vs AI",
    tabExercises: "Learn",
    whitePerspective: "White (you): bottom of board",
    blackPerspective: "Black (you): bottom of board",
    newGame: "New game",
    controls: "Controls",
    settings: "Settings",
    ...
    creditsThanks: "Acknowledgements",
    creditsSources: "Pedagogical sources",
    creditsCorpus: "Corpus",
    turn: "Turn:",
    white: "White",
    black: "Black",
    ...
    lidraughtsImportButton: "Import your Lidraughts games",
    lidraughtsUsernameLabel: "Your Lidraughts username",
    lidraughtsUsernamePlaceholder: "e.g. myusername",
    lidraughtsCountLabel: "Number of games (max 100)",
    lidraughtsImporting: "Downloading…",
    lidraughtsImported: "Lidraughts games loaded",
    lidraughtsImportError: "Could not fetch games from Lidraughts.",
  },
}
